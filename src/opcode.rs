...
lazy_static! {
    pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
        ...
        OpCode::new(0x9d, "STA", 3, 4, AddressingMode::Absolute_X, false),
        OpCode::new(0x99, "STA", 3, 4, AddressingMode::Absolute_Y, false),
        OpCode::new(0x81, "STA", 2, 6, AddressingMode::Indirect_X, false),
        OpCode::new(0x91, "STA", 2, 5, AddressingMode::Indirect_Y, false),
        ...
        OpCode::new(0x4b, "ALR", 2, 2, AddressingMode::Immediate, true),

        OpCode::new(0x0b, "ANC", 2, 2, AddressingMode::Immediate, true),

        OpCode::new(0x2b, "ANC", 2, 2, AddressingMode::Immediate, true),

        OpCode::new(0x8b, "ANE", 2, 2, AddressingMode::Immediate, true),

        OpCode::new(0x6b, "ARR", 2, 2, AddressingMode::Immediate, true),

        OpCode::new(0xc7, "DCP", 2, 5, AddressingMode::ZeroPage, true),
        OpCode::new(0xd7, "DCP", 2, 6, AddressingMode::ZeroPage_X, true),
        OpCode::new(0xcf, "DCP", 3, 6, AddressingMode::Absolute, true),
        OpCode::new(0xdf, "DCP", 3, 7, AddressingMode::Absolute_X, true),
        OpCode::new(0xdb, "DCP", 3, 7, AddressingMode::Absolute_Y, true),
        ...
        OpCode::new(0xa7, "LAX", 2, 5, AddressingMode::ZeroPage, true),
        OpCode::new(0xb7, "LAX", 2, 6, AddressingMode::ZeroPage_Y, true),
        OpCode::new(0xaf, "LAX", 3, 6, AddressingMode::Absolute, true),
        OpCode::new(0xbf, "LAX", 3, 7, AddressingMode::Absolute_Y, true),
        OpCode::new(0xa3, "LAX", 2, 8, AddressingMode::Indirect_X, true),
        OpCode::new(0xb3, "LAX", 2, 8, AddressingMode::Indirect_Y, true),

        OpCode::new(0xab, "LXA", 3, 4, AddressingMode::Immediate, true),

        OpCode::new(0x27, "RLA", 2, 5, AddressingMode::ZeroPage, true),
        OpCode::new(0x37, "RLA", 2, 6, AddressingMode::ZeroPage_X, true),
        OpCode::new(0x2f, "RLA", 3, 6, AddressingMode::Absolute, true),
        OpCode::new(0x3f, "RLA", 3, 7, AddressingMode::Absolute_X, true),
        OpCode::new(0x3b, "RLA", 3, 7, AddressingMode::Absolute_Y, true),
        OpCode::new(0x23, "RLA", 2, 8, AddressingMode::Indirect_X, true),
        OpCode::new(0x33, "RLA", 2, 8, AddressingMode::Indirect_Y, true),

        OpCode::new(0x67, "RRA", 2, 5, AddressingMode::ZeroPage, true),
        OpCode::new(0x77, "RRA", 2, 6, AddressingMode::ZeroPage_X, true),
        OpCode::new(0x6f, "RRA", 3, 6, AddressingMode::Absolute, true),
        OpCode::new(0x7f, "RRA", 3, 7, AddressingMode::Absolute_X, true),
        OpCode::new(0x7b, "RRA", 3, 7, AddressingMode::Absolute_Y, true),
        OpCode::new(0x63, "RRA", 2, 8, AddressingMode::Indirect_X, true),
        OpCode::new(0x73, "RRA", 2, 8, AddressingMode::Indirect_Y, true),

        OpCode::new(0x87, "SAX", 2, 3, AddressingMode::ZeroPage, true),
        OpCode::new(0x97, "SAX", 2, 4, AddressingMode::ZeroPage_Y, true),
        OpCode::new(0x8f, "SAX", 3, 4, AddressingMode::Absolute, true),
        OpCode::new(0x83, "SAX", 2, 6, AddressingMode::Indirect_X, true),

        OpCode::new(0xeb, "SBC", 2, 2, AddressingMode::Immediate, true),

        OpCode::new(0xcb, "SBX", 2, 2, AddressingMode::Immediate, true),

        OpCode::new(0x9f, "SHA", 3, 5, AddressingMode::Absolute_Y, true),
        OpCode::new(0x93, "SHA", 2, 6, AddressingMode::Indirect_Y, true),

        OpCode::new(0x9e, "SHX", 3, 5, AddressingMode::Absolute_Y, true),

        OpCode::new(0x9c, "SHY", 3, 5, AddressingMode::Absolute_X, true),

        OpCode::new(0x07, "SLO", 2, 5, AddressingMode::ZeroPage, true),
        OpCode::new(0x17, "SLO", 2, 6, AddressingMode::ZeroPage_X, true),
        OpCode::new(0x0f, "SLO", 3, 6, AddressingMode::Absolute, true),
        OpCode::new(0x1f, "SLO", 3, 7, AddressingMode::Absolute_X, true),
        OpCode::new(0x1b, "SLO", 3, 7, AddressingMode::Absolute_Y, true),
        OpCode::new(0x03, "SLO", 2, 8, AddressingMode::Indirect_X, true),
        OpCode::new(0x13, "SLO", 2, 8, AddressingMode::Indirect_Y, true),

        OpCode::new(0x47, "SRE", 2, 5, AddressingMode::ZeroPage, true),
        OpCode::new(0x57, "SRE", 2, 6, AddressingMode::ZeroPage_X, true),
        OpCode::new(0x4f, "SRE", 3, 6, AddressingMode::Absolute, true),
        OpCode::new(0x5f, "SRE", 3, 7, AddressingMode::Absolute_X, true),
        OpCode::new(0x5b, "SRE", 3, 7, AddressingMode::Absolute_Y, true),
        OpCode::new(0x43, "SRE", 2, 8, AddressingMode::Indirect_X, true),
        ...
        OpCode::new(0x5a, "NOP", 1, 2, AddressingMode::NoneAddressing, true),
        OpCode::new(0x7a, "NOP", 1, 2, AddressingMode::NoneAddressing, true),
        OpCode::new(0xda, "NOP", 1, 2, AddressingMode::NoneAddressing, true),
        OpCode::new(0xfa, "NOP", 1, 2, AddressingMode::NoneAddressing, true),
        OpCode::new(0x80, "NOP", 2, 2, AddressingMode::Immediate, true),
        OpCode::new(0x82, "NOP", 2, 2, AddressingMode::Immediate, true),
        OpCode::new(0x89, "NOP", 2, 2, AddressingMode::Immediate, true),
        OpCode::new(0xc2, "NOP", 2, 2, AddressingMode::Immediate, true),
        OpCode::new(0xe2, "NOP", 2, 2, AddressingMode::Immediate, true),
        OpCode::new(0x04, "NOP", 2, 3, AddressingMode::ZeroPage, true),
        OpCode::new(0x44, "NOP", 2, 3, AddressingMode::ZeroPage, true),
        OpCode::new(0x64, "NOP", 2, 3, AddressingMode::ZeroPage, true),
        OpCode::new(0x14, "NOP", 2, 4, AddressingMode::ZeroPage_X, true),
        OpCode::new(0x34, "NOP", 2, 4, AddressingMode::ZeroPage_X, true),
        OpCode::new(0x54, "NOP", 2, 4, AddressingMode::ZeroPage_X, true),
        OpCode::new(0x74, "NOP", 2, 4, AddressingMode::ZeroPage_X, true),
        OpCode::new(0xd4, "NOP", 2, 4, AddressingMode::ZeroPage_X, true),
        OpCode::new(0xf4, "NOP", 2, 4, AddressingMode::ZeroPage_X, true),
        OpCode::new(0x0c, "NOP", 3, 4, AddressingMode::Absolute, true),
        OpCode::new(0x1c, "NOP", 3, 4, AddressingMode::Absolute_X, true),
        OpCode::new(0x3c, "NOP", 3, 4, AddressingMode::Absolute_X, true),
        OpCode::new(0x5c, "NOP", 3, 4, AddressingMode::Absolute_X, true),
        OpCode::new(0x7c, "NOP", 3, 4, AddressingMode::Absolute_X, true),
        OpCode::new(0xdc, "NOP", 3, 4, AddressingMode::Absolute_X, true),
        OpCode::new(0xfc, "NOP", 3, 4, AddressingMode::Absolute_X, true),

        OpCode::new(0x02, "JAM", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0x12, "JAM", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0x22, "JAM", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0x32, "JAM", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0x42, "JAM", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0x52, "JAM", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0x62, "JAM", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0x72, "JAM", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0x92, "JAM", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0xb2, "JAM", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0xd2, "JAM", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0xf2, "JAM", 1, 0, AddressingMode::NoneAddressing, true),
    ];

    pub static ref CPU_OPS_LOOKUP: HashMap<u8, &'static OpCode> = {
        let mut ret = HashMap::new();
        for code in CPU_OPS_CODES.iter() {
            ret.insert(code.opcode, code);
        }
        ret
    };
}